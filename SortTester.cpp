...
int main() {
    BucketSort pbs;
    pbs.numbersToSort.push_back(32);
    pbs.numbersToSort.push_back(53);
    pbs.numbersToSort.push_back(3);
    pbs.numbersToSort.push_back(134);
    pbs.numbersToSort.push_back(643);
    pbs.numbersToSort.push_back(3);
    pbs.numbersToSort.push_back(5);
    pbs.numbersToSort.push_back(12);
    pbs.numbersToSort.push_back(52);
    pbs.numbersToSort.push_back(501);
    pbs.numbersToSort.push_back(98);
    
    pbs.sort(4);
    
    for (unsigned int i: pbs.numbersToSort){
        std::cout << i << " ";
    }
